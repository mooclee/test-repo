			...
			<table class="datatable" style="width:100%">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<button class="details_button" onclick="togglePage('#div_oclx_coord1')">Details</button>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<button class="details_button" onclick="togglePage('#div_oclx_coord2')">Details</button>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<button class="details_button" onclick="togglePage('#div_oclx_coord3')">Details</button>
						</td>
					</tr>
...
<!--OCLX 1-->
<div id="div_oclx_coord1" class="display_page">
	<table class="layout_box" cellspacing="0" cellpadding="5" style="width:100%">
			...
			<td>
				<table style="width:100%">
					<thead>
						...
						<td width="24">
							<span class="svg_container svg_button" svg="edit" svgfill="black" svgsize="24" onclick="toggleEdit($('#div_oclx_coord_profile1'))"></span>
						</td>
					</thead>
				</table>
			</td>
		...
		<tr>
			<td>
				<div id="div_oclx_coord_profile1">
...
<!--OCLX 2-->
<div id="div_oclx_coord2" class="display_page">
	<table class="layout_box" cellspacing="0" cellpadding="5" style="width:100%">
			...
			<td>
				<table style="width:100%">
					<thead>
						...
						<td width="24">
							<span class="svg_container svg_button" svg="edit" svgfill="black" svgsize="24" onclick="toggleEdit($('#div_oclx_coord_profile2'))"></span>
						</td>
					</thead>
				</table>
			</td>
		...
		<tr>
			<td>
				<div id="div_oclx_coord_profile2">
					<table width="100%" border="0">
						<tr>
							<td align="center">
...
<!--OCLX 3-->
<div id="div_oclx_coord3" class="display_page">
	<table class="layout_box" cellspacing="0" cellpadding="5" style="width:100%">
			...
			<td>
				<table style="width:100%">
					<thead>
						...
						<td width="24">
							<span class="svg_container svg_button" svg="edit" svgfill="black" svgsize="24" onclick="toggleEdit($('#div_oclx_coord_profile3'))"></span>
						</td>
					</thead>
				</table>
			</td>
		...
		<tr>
			<td>
				<div id="div_oclx_coord_profile3">
					<table width="100%" border="0">
						<tr>
							<td align="center">
