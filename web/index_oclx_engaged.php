				...
				<tr>
					<td>
						<table class="tbl_activity">
							...
							<tr>
								<td colspan="2" align="center">
									<video width="800" height="480" controls="1">
										<source src="./video/GCSI_360p.mp4" type="video/mp4"/>
									</video>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<ul>
										<li>
											<span class="stamper_header">Darrum Holmes</span><span class="svg_container" svg="stamp" svgfill="black" svgsize="15"></span>
										</li>
									</ul>
								</td>
							</tr>
						...
						<table class="tbl_activity">
							<tr>
								<td colspan="2" valign="top" align="center">
									<img src="./oclx/earthquake.jpg" class="photo_homex"/>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2" align="center">
									<video width="800" height="480" controls="1">
										<source src="./video/earthquake.mp4" type="video/mp4"/>
									</video>
								</td>
							</tr>
				...
				<tr>
					<td>
						<table class="tbl_activity">
							<tr>
								<td colspan="2" valign="top" align="center">
									<img src="./oclx/science_society.jpg" class="photo_homex"/>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2" align="center">
									<video width="800" height="480" controls="1">
										<source src="./video/hkuss_360p.mp4" type="video/mp4"/>
									</video>
								</td>
							</tr>
