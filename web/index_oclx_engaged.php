			...
			<table class="datatable" style="width:100%">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<button class="details_button" onclick="togglePage('#div_oclx_engaged1')">Details</button>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<button class="details_button" onclick="togglePage('#div_oclx_engaged2')">Details</button>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<button class="details_button" onclick="togglePage('#div_oclx_engaged3')">Details</button>
						</td>
					</tr>
...
<!--OCLX 1-->
<div id="div_oclx_engaged1" class="display_page">
	...
	<table class="layout_box" cellspacing="0" cellpadding="5" style="width:100%">
		...
		<tr>
			<td>
				<table style="width:100%">
					<thead>
						<td>
							<div class="div_title" index="1"></div>
						</td>
						<td width="150">
							<div class="div_date" index="1"></div>
						</td>
						<td width="24">
							<span class="svg_container svg_button" svg="edit" svgfill="black" svgsize="24" onclick="toggleEdit($('#div_oclx_engaged_profile1'))"></span>
						</td>
					</thead>
				</table>
			</td>
		...
		<tr>
			<td>
				<div id="div_oclx_engaged_profile1">
					<table width="100%" border="0">
						<tr>
							<td align="center">
								<div class="div_desc" style="text-align:justify" index="1"></div>
							</td>
						</tr>
						<tr>
							<td align="center">
								<img class="img_act" index="1"/>
							</td>
						</tr>
						<tr>
							<td align="center">
								<iframe class="ifrm_youtube" src="" frameborder="0" index="1" allowfullscreen></iframe>
							</td>
						</tr>
					</table>	
				</div>
...
<!--OCLX 2-->
<div id="div_oclx_engaged2" class="display_page">
	<table class="layout_box" cellspacing="0" cellpadding="5" style="width:100%">
		...
		<tr>
			<td>
				<table style="width:100%">
					<thead>
						<td>
							<div class="div_title" index="2"></div>
						</td>
						<td width="150">
							<div class="div_date" index="2"></div>
						</td>
						<td width="24">
							<span class="svg_container svg_button" svg="edit" svgfill="black" svgsize="24" onclick="toggleEdit($('#div_oclx_engaged_profile2'))"></span>
						</td>
					</thead>
				</table>
			</td>
		...
		<tr>
			<td>
				<div id="div_oclx_engaged_profile2">
					<table width="100%" border="0">
						<tr>
							<td align="center">
								<div class="div_desc" style="text-align:justify" index="2"></div>
							</td>
						</tr>
						<tr>
							<td align="center">
								<img class="img_act" index="2"/>
							</td>
						</tr>
						<tr>
							<td align="center">
								<iframe class="ifrm_youtube" src="" frameborder="0" index="2" allowfullscreen></iframe>
							</td>
						</tr>
					</table>	
				</div>
				...
				<table width="100%">
					...
					<tr>
						...
						<td>
							<ul>
								<li>
									<span class="stamper_header">Philip Chan</span><span class="svg_container" svg="stamp" svgfill="black" svgsize="15"></span>
								</li>
							</ul>
						</td>
...
<div id="div_oclx_engaged3" class="display_page">
	<table class="layout_box" cellspacing="0" cellpadding="5" style="width:100%">
		...
		<tr>
			<td>
				<table style="width:100%">
					<thead>
						<td>
							<div class="div_title" index="3"></div>
						</td>
						<td width="150">
							<div class="div_date" index="3"></div>
						</td>
						<td width="24">
							<span class="svg_container svg_button" svg="edit" svgfill="black" svgsize="24" onclick="toggleEdit($('#div_oclx_engaged_profile3'))"></span>
						</td>
					</thead>
				</table>
			</td>
		...
		<tr>
			<td>
				<div id="div_oclx_engaged_profile3">
					<table width="100%" border="0">
						<tr>
							<td align="center">
								<div class="div_desc" style="text-align:justify" index="3"></div>
							</td>
						</tr>
						<tr>
							<td align="center">
								<img class="img_act" index="3"/>
							</td>
						</tr>
						<tr>
							<td align="center">
								<iframe class="ifrm_youtube" src="" frameborder="0" index="3" allowfullscreen></iframe>
							</td>
						</tr>
					</table>	
				</div>
