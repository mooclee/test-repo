    ...
    Publication.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: 
						'<div class="publication_outer">' +
							...
							'</div>' +
							'<div class="editable-publication">Description</div><div class="editable-publication"><div contenteditable="true" class="input_desc contenteditable" autocomplete="off" onclick="$(this).focus()"></div>' + 
						'</div>',
        inputclass: '',
    });
