    ...
    Work.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: 
						'<div class="work_outer">' +
							...
							'</div>' +
							'<div class="editable-work">Description</div><div class="editable-work"><div contenteditable="true" class="input_desc contenteditable" autocomplete="off" onclick="$(this).focus()"></div>' + 
						'</div>',
        inputclass: '',
    });
