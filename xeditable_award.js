    ...
    Award.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: 
						'<div class="award_outer">' +
							...
							'</div>' +
							'<div class="editable-award">Description</div><div class="editable-award"><div contenteditable="true" class="input_desc contenteditable" autocomplete="off"  onclick="$(this).focus()"></div>' + 
						'</div>',
        inputclass: '',
    });
